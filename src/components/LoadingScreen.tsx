...
export default function LoadingScreen({ onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    // Exit after enough time to read
    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          {/* Glass orb — top right, smaller caustic */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            style={{
              ...
              borderRadius: "50%",
              background: "radial-gradient(circle at 40% 35%, rgba(255,255,255,0.09) 0%, transparent 65%)",
              border: "1px solid rgba(255,255,255,0.06)",
              pointerEvents: "none",
            }}
          />

          {/* Caustic light streak — horizontal */}
          <motion.div
          ...
          {/* Sub-label — fades in as distortion clears */}
          <motion.div
          ...
          {/* Teal pulse dot — bottom right corner */}
          <motion.div
            initial={{ opacity: 0 }}
            ...
            style={{
              ...
              borderRadius: "50%",
              background: "#00C2A8",
              boxShadow: "0 0 10px rgba(0,194,168,0.6)",
            }}
          />
        </motion.div>
      )}
